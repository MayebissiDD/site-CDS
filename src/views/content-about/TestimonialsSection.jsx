...
function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      name: 'Sophie Martin',
      role: 'Head of Marketing, Adipiscing Elit',
      testimony: 'Congo Digital Services nous a permis de moderniser notre approche et de mieux répondre aux attentes de nos clients.',
      photo: 'https://via.placeholder.com/100',
    },
    {
      name: 'Lucie Dubois',
      role: 'Lead Developer, Sed Do',
      testimony: 'Une collaboration fluide et des résultats qui dépassent nos attentes. Je recommande vivement Congo Digital Services.',
      photo: 'https://via.placeholder.com/100',
    },
  ];
  ...
  const items = testimonials.map((testimonial, index) => (
    <motion.div
      key={index}
      className="relative p-6 mx-4 transition-all duration-300 bg-white border-t-4 rounded-lg shadow-lg border-second-color hover:border-first-color"
    ...
    >
      ...
      <p className="mb-4 italic text-gray-700 font-lato">
        {truncateText(testimonial.testimony, maxLength)}
      </p>
