...
import archiveReseauImg from './../../../assets/images/service/archivage1.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4 text-center text-white">
        ...
        >
          Sécurisez vos documents et optimisez leur gestion avec nos solutions d'archivage numérique.
        </motion.p>
        <motion.div
          className="mt-8"
          initial={{ opacity: 0 }}
