...
import reseauImg from './../../../assets/images/service/reseau.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4 text-center text-white">
        ...
        >
          Assurez la continuité de vos opérations avec des réseaux robustes et sécurisés, adaptés aux besoins spécifiques de votre entreprise.
        </motion.p>
        <motion.div
          className="mt-8"
          initial={{ opacity: 0 }}
