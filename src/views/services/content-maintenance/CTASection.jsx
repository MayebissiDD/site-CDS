      ...
      <div className="container px-4 mx-auto text-center">
        ...
        >
          <h2 className="text-3xl font-bold text-white md:text-5xl font-montserrat">
            Prêt à Assurer la Continuité de Vos Systèmes ?
          </h2>
          <p className="max-w-2xl mx-auto mt-4 text-lg leading-relaxed text-white md:text-xl font-lato">
            Contactez-nous dès aujourd'hui pour bénéficier de nos services de maintenance et support. Notre équipe d'experts est prête à vous accompagner pour garantir la fiabilité et la sécurité de vos infrastructures.
          </p>
        </motion.div>
        <motion.div
