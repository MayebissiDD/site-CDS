...
import marketingImg from './../../../assets/images/service/recrutement.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4 text-center text-white">
        ...
        >
          C'est une autre dynamique de recrutement qui vous donne la possibilité de travailler pour nous comme pour d'autres.
        </motion.p>
        <motion.div
          className="mt-8"
          initial={{ opacity: 0 }}
        ...
        >
          <button className="px-8 py-3 font-semibold transition duration-300 bg-white rounded-md text-black-color hover:bg-second-color hover:text-white">
            Découvrez nos offres et Postulez
          </button>
        </motion.div>
      </div>
    </section>
