      ...
      <div className="container px-4 mx-auto text-center">
        ...
        >
          <h2 className="text-3xl font-bold text-white md:text-5xl font-montserrat">
            Protégez Vos Infrastructures Dès Maintenant
          </h2>
          <p className="max-w-2xl mx-auto mt-4 text-lg leading-relaxed text-white md:text-xl font-lato">
            Contactez-nous pour discuter de vos besoins en sécurité et découvrir comment nous pouvons vous aider à protéger vos systèmes contre les menaces actuelles.
          </p>
        </motion.div>
        <motion.div
