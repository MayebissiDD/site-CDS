      ...
      <div className="container px-4 mx-auto text-center">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto mt-4 text-lg leading-relaxed text-white md:text-xl font-lato">
            Contactez-nous dès aujourd'hui pour démarrer votre projet avec notre équipe d'experts. Nous sommes prêts à vous accompagner à chaque étape du processus de développement.
          </p>
        </motion.div>
        <motion.div
