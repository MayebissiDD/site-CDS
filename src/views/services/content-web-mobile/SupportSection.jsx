...
function SupportSection() {
  const supportItems = [
    ...
    },
    {
      ...
      description: 'Profitez des dernières mises à jour et améliorations pour maintenir vos applications à jour.',
      icon: '🔄',
    },
    {
      title: 'Sécurité renforcée',
      description: 'Nous mettons en place les meilleures pratiques pour sécuriser vos applications et protéger vos données.',
      icon: '🔐',
    },
    {
      title: 'Documentation complète',
      description: 'Accédez à une documentation détaillée pour comprendre et exploiter toutes les fonctionnalités de vos solutions.',
      icon: '📚',
    },
  ];
      ...
      <div className="container px-4 mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold md:text-5xl text-first-color font-montserrat">
            Un Support Dédié Pour Vous Accompagner
          </h2>
          <p className="max-w-3xl mx-auto mt-4 text-lg leading-relaxed text-gray-600 md:text-xl font-lato">
            Notre engagement ne s'arrête pas à la livraison de votre projet. Nous vous offrons un support continu pour garantir le succès et la pérennité de vos solutions numériques.
          </p>
        </motion.div>
